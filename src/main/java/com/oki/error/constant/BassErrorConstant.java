package com.oki.error.constant;

public class BassErrorConstant {
	...
	public static final String NOT_EXIST_CONTENT = "not_exist_content";
	public static final String RSS_FEED_PARSING_FAILURE = "rss_feed_parsing_failure";
